                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table id="file_export" class="table table-striped table-bordered display">
					  ...
					  <?php  
						$i=1;
						$sql="SELECT * from tbl_add_daimond "; 
                  ...
                  <div id="edit-contact<?php echo $row['id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
					...
					<?php 
						$id=$row['id'];
						$exe="SELECT * FROM tbl_add_daimond where id='$id' ";
				  ...
				  <div class="modal-dialog modal-lg" role="document">
					...
					<?php 
						$id=$row['id'];
						$execution="SELECT * FROM tbl_add_daimond where id='$id' ";
...
if ($_POST["delete"])
{
	 ...
	 unlink("assets/images/gallery/thumb/".$user_image);
		$sql="DELETE FROM tbl_add_daimond  WHERE id='$id'";
		$res=mysqli_query($con,$sql);
		if($res){
			echo '<script type="text/javascript">alert("Deleted sucessfully");window.location.href = "view_daimond.php";</script>';
...
if (isset($_POST['update'])) {
    ...
    if (!empty($file_name)) {
        ...
        if (!in_array($image_mime, $valid_image_check)) {
            echo '<script type="text/javascript">alert("Invalid image format.");window.location.href = "view_daimond.php";</script>';
            exit();
        }
  ...
  echo $sql ="UPDATE tbl_add_daimond SET user_id='$user_id',user_name='$user_name' WHERE id='$id'";
    ...
    if ($result) {
        echo '<script type="text/javascript">alert("Updated successfully.");window.location.href = "view_daimond.php";</script>';
    } else {
