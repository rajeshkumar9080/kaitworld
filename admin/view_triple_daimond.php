  ...
  $filename = $_FILES["user_image"]["name"];
                    ...
                    if (in_array($_FILES["user_image"]["type"], $allowed_types)) {
                        ...
                        if ($_FILES["user_image"]["size"] <= $max_size) {
                            ...
                            echo  $sql_query ="INSERT INTO  tbl_add_triple_daimond (user_id,user_name,user_image,registered_date)VALUES ('$user_id','$user_name','$filename','$registered_date')";
                              $query = mysqli_query($con,$sql_query); 
                              // $result = mysqli_num_rows($query);
                              if ($query) { 
                                // file uplaoded successfully.
                        echo '<script type="text/javascript">alert("Insert Sucessfully");
                               window.location.href = "view_triple_daimond.php";</script>';
                              }else{
...
if (isset($_POST['update'])) {
    ...
    if (!empty($file_name)) {
        ...
        unlink("assets/images/gallery/thumb/" . $user_image);
    echo $sql ="UPDATE tbl_add_triple_daimond SET user_id='$user_id',user_name='$user_name',user_image='$file_name' WHERE id='$id'";
    } else {
