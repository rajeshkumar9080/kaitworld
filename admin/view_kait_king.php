                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table id="file_export" class="table table-striped table-bordered display">
					  ...
					  <?php  
						$i=1;
						$sql="SELECT * from tbl_add_kait_king"; 
                  ...
                  <div id="edit-contact<?php echo $row['id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
					...
					<?php 
						$id=$row['id'];
						$exe="SELECT * FROM  tbl_add_kait_king where id='$id' ";
				  ...
				  <div class="modal-dialog modal-lg" role="document">
					...
					<?php 
						$id=$row['id'];
						$execution="	SELECT * FROM  tbl_add_kait_king where id='$id' ";
  ...
  $filename = $_FILES["user_image"]["name"];
                    ...
                    if (in_array($_FILES["user_image"]["type"], $allowed_types)) {
                        ...
                        if ($_FILES["user_image"]["size"] <= $max_size) {
                            ...
                            echo  $sql_query ="INSERT INTO  tbl_add_kait_king (user_id,user_name,user_image,registered_date)VALUES ('$user_id','$user_name','$filename','$registered_date')";
                              $query = mysqli_query($con,$sql_query); 
                              // $result = mysqli_num_rows($query);
                              if ($query) { 
                                // file uplaoded successfully.
                        echo '<script type="text/javascript">alert("Insert Sucessfully");
                               window.location.href = "view_kait_king.php";</script>';
                              }else{
...
if ($_POST["delete"])
{
	 ...
	 unlink("assets/images/gallery/thumb/".$user_image);
		$sql="DELETE FROM  tbl_add_kait_king  WHERE id='$id'";
		$res=mysqli_query($con,$sql);
		if($res){
			echo '<script type="text/javascript">alert("Deleted sucessfully");window.location.href = "view_kait_king.php";</script>';
...
if (isset($_POST['update'])) {
    ...
    if (!empty($file_name)) {
        ...
        if (!in_array($image_mime, $valid_image_check)) {
            echo '<script type="text/javascript">alert("Invalid image format.");window.location.href = "view_kait_king.php";</script>';
            exit();
        }
        
        // Move uploaded file
        if (!move_uploaded_file($_FILES["img_files"]["tmp_name"], $filepath)) {
            echo '<script type="text/javascript">alert("Failed to upload '. $_FILES["img_files"]["name"] . '");window.location.href = "view_kait_king.php";</script>';
            exit();
        }
        ...
        unlink("assets/images/gallery/thumb/" . $user_image);
    echo $sql ="UPDATE tbl_add_kait_king SET user_id='$user_id',user_name='$user_name',user_image='$file_name' WHERE id='$id'";
    } else {
        // Update without changing the image
  echo $sql ="UPDATE tbl_add_kait_king SET user_id='$user_id',user_name='$user_name' WHERE id='$id'";
    }

    $result = mysqli_query($con, $sql);
    if ($result) {
        echo '<script type="text/javascript">alert("Updated successfully.");window.location.href = "view_kait_king.php";</script>';
    } else {
        echo '<script type="text/javascript">alert("Failed to update.");window.location.href = "view_kait_king.php";</script>';
    }
  }
?>
