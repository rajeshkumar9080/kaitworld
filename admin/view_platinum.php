  ...
  $filename = $_FILES["user_image"]["name"];
                    ...
                    if (in_array($_FILES["user_image"]["type"], $allowed_types)) {
                        ...
                        if ($_FILES["user_image"]["size"] <= $max_size) {
                            ...
                            echo  $sql_query ="INSERT INTO tbl_add_platinum (user_id,user_name,user_image,registered_date)VALUES ('$user_id','$user_name','$filename','$registered_date')";
...
if (isset($_POST['update'])) {
    ...
    if (!empty($file_name)) {
        ...
        unlink("assets/images/gallery/thumb/" . $user_image);
    echo $sql ="UPDATE tbl_add_platinum SET user_id='$user_id',user_name='$user_name',user_image='$file_name' WHERE id='$id'";
    } else {
        // Update without changing the image
  echo $sql ="UPDATE tbl_add_platinum SET user_id='$user_id',user_name='$user_name' WHERE id='$id'";
    }
