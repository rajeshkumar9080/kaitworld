                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table id="file_export" class="table table-striped table-bordered display">
					  ...
					  <?php 
						$i=1;
						$sql="SELECT * from tbl_add_contest "; 
...
if ($_POST["delete"])
{
	 ...
	 unlink("assets/images/gallery/thumb/".$image);
		$sql="DELETE FROM tbl_add_contest WHERE id='$id'";
		$res=mysqli_query($con,$sql);
		if($res){
			echo '<script type="text/javascript">alert("Deleted sucessfully");window.location.href = "view_contest.php";</script>';
...
if (isset($_POST['update'])) {
    ...
    if ($result) {
        echo '<script type="text/javascript">alert("Updated successfully.");window.location.href = "view_contest.php";</script>';
    } else {
